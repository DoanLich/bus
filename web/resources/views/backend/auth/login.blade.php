...
<head>
    ...
    <title>{{ trans('backend/systems.login') }} | {{ config('app.name') }}</title>
                            ...
                            {!! Form::open(['route' => 'admin.login', 'method' => 'POST']) !!}
                                ...
                                <div class="form-group">
                                    <div class="checkbox3 checkbox-inline checkbox-check checkbox-light">
                                        ...
                                        <label for="checkbox-remember"> {!! trans('validation.attributes.remember') !!}</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="pull-left">
                                            <button type="submit" class="btn btn-primary">{{ trans('backend/systems.login') }}</button>
                                        </div>
                                        <div class="pull-right">
                                            <a class="btn btn-default" href="{{ route('admin.password.email') }}">{{ trans('backend/systems.reset_password') }}</a>
                                        </div>
                                    </div>
                                </div>
                            {!! Form::close() !!}
